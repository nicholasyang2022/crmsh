...
61: tun0    inet 10.163.45.46 peer 10.163.45.45/32 scope global tun0"""
    ...
    def test_get_nic_by_subnet_of_addr_match(self, mock_getaddrinfo, mock_shell_cls):
        ...
        assert self.interfaces_info.get_nic_by_subnet_of_addr("qnetd.example.com") == "eth0"

        # Match IPv6 on eth0
        mock_getaddrinfo.return_value = [(socket.AF_INET6, socket.SOCK_STREAM, 6, "", ("2001:db8::50", 0, 0, 0))]
        assert self.interfaces_info.get_nic_by_subnet_of_addr("2001:db8::50") == "eth0"

        # Match IPv4 on eth1
        mock_getaddrinfo.return_value = [(socket.AF_INET, socket.SOCK_STREAM, 6, "", ("10.0.0.50", 0))]
        assert self.interfaces_info.get_nic_by_subnet_of_addr("10.0.0.50") == "eth1"
    ...
    def test_get_nic_by_subnet_of_addr_no_match(self, mock_getaddrinfo, mock_shell_cls):
        ...
        assert self.interfaces_info.get_nic_by_subnet_of_addr("172.16.0.1") is None
    ...
    def test_get_nic_by_subnet_of_addr_ignore_loopback(self, mock_getaddrinfo, mock_shell_cls):
        ...
        assert self.interfaces_info.get_nic_by_subnet_of_addr("127.0.0.2") is None
