...
def test_get_local_node_ring_addresses(mock_get_values, mock_this_node):
    ...
    res = corosync.get_local_node_ring_addresses()
...
@mock.patch("crmsh.corosync.get_local_node_ring_addresses")
def test_get_corosync_interfaces(mock_get_addrs):
    mock_get_addrs.return_value = ["192.168.1.10", "10.0.0.10"]
    mock_iface_inst = mock.Mock()
    mock_iface_inst.get_nic_by_subnet_of_addr.side_effect = ["eth0", "eth1"]
    res = corosync.get_corosync_interfaces(interfaces_inst=mock_iface_inst)
