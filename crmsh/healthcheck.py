...
class PasswordlessHaclusterAuthenticationFeature(Feature):
    ...
    def fix_cluster(self, nodes: typing.Iterable[str], ask: typing.Callable[[str], None]) -> None:
        ...
        if nodes_without_keys:
            ...
            # TODO: remove me
            print('init_node: {}'.format(init_node), file=sys.stderr)
            print('join_nodes: {}'.format(join_nodes), file=sys.stderr)
            print('join_target_node: {}'.format(join_target_node), file=sys.stderr)
