...
def disable_completion():
    if _global_variables and _global_variables.ui_global_variables:
        _global_variables.ui_global_variables.disable_completion()


def enable_completion():
    if _global_variables and _global_variables.ui_global_variables:
        _global_variables.ui_global_variables.setup_readline()
